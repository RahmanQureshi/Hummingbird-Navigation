classdef FileOpenRequest < robotics.ros.Message
    ...
    methods
        function obj = FileOpenRequest(msg)
            %FileOpenRequest Construct the message object FileOpenRequest
        ...
        function set.FilePath(obj, filepath)
            ...
            validateattributes(filepath, {'char'}, {}, 'FileOpenRequest', 'FilePath');
        ...
        function set.Mode(obj, mode)
            ...
            validateattributes(mode, {'numeric'}, {'nonempty', 'scalar'}, 'FileOpenRequest', 'Mode');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileOpenRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileOpenRequest;
            obj.reload(strObj);
        end
    end
end
