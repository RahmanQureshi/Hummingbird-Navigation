classdef CommandIntResponse < robotics.ros.Message
    %CommandIntResponse MATLAB implementation of mavros_msgs/CommandIntResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/CommandIntResponse' % The ROS message type
    end
    ...
    methods
        function obj = CommandIntResponse(msg)
            %CommandIntResponse Construct the message object CommandIntResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'CommandIntResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.CommandIntResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.CommandIntResponse;
            obj.reload(strObj);
        end
    end
end
