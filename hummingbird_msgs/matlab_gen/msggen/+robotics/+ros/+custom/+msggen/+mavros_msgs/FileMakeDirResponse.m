classdef FileMakeDirResponse < robotics.ros.Message
    %FileMakeDirResponse MATLAB implementation of mavros_msgs/FileMakeDirResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileMakeDirResponse' % The ROS message type
    end
    ...
    methods
        function obj = FileMakeDirResponse(msg)
            %FileMakeDirResponse Construct the message object FileMakeDirResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileMakeDirResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileMakeDirResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileMakeDirResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileMakeDirResponse;
            obj.reload(strObj);
        end
    end
end
