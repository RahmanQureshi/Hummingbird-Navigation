classdef CommandBoolRequest < robotics.ros.Message
    ...
    methods
        function obj = CommandBoolRequest(msg)
            %CommandBoolRequest Construct the message object CommandBoolRequest
        ...
        function set.Value(obj, value)
            ...
            validateattributes(value, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'CommandBoolRequest', 'Value');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.CommandBoolRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.CommandBoolRequest;
            obj.reload(strObj);
        end
    end
end
