classdef FileRemoveResponse < robotics.ros.Message
    %FileRemoveResponse MATLAB implementation of mavros_msgs/FileRemoveResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileRemoveResponse' % The ROS message type
    end
    ...
    methods
        function obj = FileRemoveResponse(msg)
            %FileRemoveResponse Construct the message object FileRemoveResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileRemoveResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileRemoveResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveResponse;
            obj.reload(strObj);
        end
    end
end
