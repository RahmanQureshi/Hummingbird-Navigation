classdef SetMavFrameResponse < robotics.ros.Message
    %SetMavFrameResponse MATLAB implementation of mavros_msgs/SetMavFrameResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/SetMavFrameResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetMavFrameResponse(msg)
            %SetMavFrameResponse Construct the message object SetMavFrameResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetMavFrameResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.SetMavFrameResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.SetMavFrameResponse;
            obj.reload(strObj);
        end
    end
end
