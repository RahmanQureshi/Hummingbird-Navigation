classdef RCIn < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        PropertyList = {'Channels', 'Header', 'Rssi'} % List of non-constant message properties
        ROSPropertyList = {'channels', 'header', 'rssi'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = RCIn(msg)
            %RCIn Construct the message object RCIn
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'RCIn', 'Header');
        ...
        function set.Rssi(obj, rssi)
            ...
            validateattributes(rssi, {'numeric'}, {'nonempty', 'scalar'}, 'RCIn', 'Rssi');
        ...
        function set.Channels(obj, channels)
            ...
            if ~isvector(channels) && isempty(channels)
                % Allow empty [] input
                channels = uint16.empty(0,1);
            end
            
            validateattributes(channels, {'numeric'}, {'vector'}, 'RCIn', 'Channels');
            
            javaArray = obj.JavaMessage.getChannels;
            array = obj.writeJavaArray(channels, javaArray, 'uint16');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.RCIn.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.RCIn;
            obj.reload(strObj);
        end
    end
end
