classdef FileRemoveRequest < robotics.ros.Message
    ...
    methods
        function obj = FileRemoveRequest(msg)
            %FileRemoveRequest Construct the message object FileRemoveRequest
        ...
        function set.FilePath(obj, filepath)
            ...
            validateattributes(filepath, {'char'}, {}, 'FileRemoveRequest', 'FilePath');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveRequest;
            obj.reload(strObj);
        end
    end
end
