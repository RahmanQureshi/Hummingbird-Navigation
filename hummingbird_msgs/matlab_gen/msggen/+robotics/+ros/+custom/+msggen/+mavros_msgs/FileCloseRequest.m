classdef FileCloseRequest < robotics.ros.Message
    ...
    methods
        function obj = FileCloseRequest(msg)
            %FileCloseRequest Construct the message object FileCloseRequest
        ...
        function set.FilePath(obj, filepath)
            ...
            validateattributes(filepath, {'char'}, {}, 'FileCloseRequest', 'FilePath');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileCloseRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileCloseRequest;
            obj.reload(strObj);
        end
    end
end
