classdef FileCloseResponse < robotics.ros.Message
    ...
    methods
        function obj = FileCloseResponse(msg)
            %FileCloseResponse Construct the message object FileCloseResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileCloseResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileCloseResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileCloseResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileCloseResponse;
            obj.reload(strObj);
        end
    end
end
