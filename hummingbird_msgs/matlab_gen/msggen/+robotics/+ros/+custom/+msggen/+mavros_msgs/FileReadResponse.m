classdef FileReadResponse < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        PropertyList = {'Data', 'RErrno', 'Success'} % List of non-constant message properties
        ROSPropertyList = {'data', 'r_errno', 'success'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = FileReadResponse(msg)
            %FileReadResponse Construct the message object FileReadResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileReadResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileReadResponse', 'RErrno');
        ...
        function set.Data(obj, data)
            ...
            validateattributes(data, {'numeric'}, {'vector'}, 'FileReadResponse', 'Data');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileReadResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileReadResponse;
            obj.reload(strObj);
        end
    end
end
