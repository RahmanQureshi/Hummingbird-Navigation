classdef FileRemoveDirResponse < robotics.ros.Message
    %FileRemoveDirResponse MATLAB implementation of mavros_msgs/FileRemoveDirResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileRemoveDirResponse' % The ROS message type
    end
    ...
    methods
        function obj = FileRemoveDirResponse(msg)
            %FileRemoveDirResponse Construct the message object FileRemoveDirResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileRemoveDirResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileRemoveDirResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveDirResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileRemoveDirResponse;
            obj.reload(strObj);
        end
    end
end
