classdef FileChecksumRequest < robotics.ros.Message
    %FileChecksumRequest MATLAB implementation of mavros_msgs/FileChecksumRequest
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileChecksumRequest' % The ROS message type
    end
    ...
    methods
        function obj = FileChecksumRequest(msg)
            %FileChecksumRequest Construct the message object FileChecksumRequest
        ...
        function set.FilePath(obj, filepath)
            ...
            validateattributes(filepath, {'char'}, {}, 'FileChecksumRequest', 'FilePath');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileChecksumRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileChecksumRequest;
            obj.reload(strObj);
        end
    end
end
