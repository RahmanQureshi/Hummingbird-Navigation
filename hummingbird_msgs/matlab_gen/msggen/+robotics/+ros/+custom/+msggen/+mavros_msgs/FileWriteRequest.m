classdef FileWriteRequest < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        PropertyList = {'Data', 'FilePath', 'Offset'} % List of non-constant message properties
        ROSPropertyList = {'data', 'file_path', 'offset'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = FileWriteRequest(msg)
            %FileWriteRequest Construct the message object FileWriteRequest
        ...
        function set.FilePath(obj, filepath)
            ...
            validateattributes(filepath, {'char'}, {}, 'FileWriteRequest', 'FilePath');
        ...
        function set.Offset(obj, offset)
            ...
            validateattributes(offset, {'numeric'}, {'nonempty', 'scalar'}, 'FileWriteRequest', 'Offset');
        ...
        function set.Data(obj, data)
            ...
            validateattributes(data, {'numeric'}, {'vector'}, 'FileWriteRequest', 'Data');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileWriteRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileWriteRequest;
            obj.reload(strObj);
        end
    end
end
