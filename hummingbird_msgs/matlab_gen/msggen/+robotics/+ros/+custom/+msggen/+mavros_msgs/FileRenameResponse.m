classdef FileRenameResponse < robotics.ros.Message
    %FileRenameResponse MATLAB implementation of mavros_msgs/FileRenameResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileRenameResponse' % The ROS message type
    end
    ...
    methods
        function obj = FileRenameResponse(msg)
            %FileRenameResponse Construct the message object FileRenameResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileRenameResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileRenameResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileRenameResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileRenameResponse;
            obj.reload(strObj);
        end
    end
end
