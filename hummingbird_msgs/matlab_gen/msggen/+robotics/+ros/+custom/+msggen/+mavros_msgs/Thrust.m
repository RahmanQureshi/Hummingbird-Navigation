classdef Thrust < robotics.ros.Message
    ...
    methods
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'Thrust', 'Header');
        ...
        function thrust_ = get.Thrust_(obj)
            ...
            thrust_ = single(obj.JavaMessage.getThrust);
        end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.Thrust.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.Thrust;
            obj.reload(strObj);
        end
    end
end
