classdef FileWriteResponse < robotics.ros.Message
    %FileWriteResponse MATLAB implementation of mavros_msgs/FileWriteResponse
    ...
    properties (Constant)
        MessageType = 'mavros_msgs/FileWriteResponse' % The ROS message type
    end
    ...
    methods
        function obj = FileWriteResponse(msg)
            %FileWriteResponse Construct the message object FileWriteResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'FileWriteResponse', 'Success');
        ...
        function set.RErrno(obj, rerrno)
            ...
            validateattributes(rerrno, {'numeric'}, {'nonempty', 'scalar'}, 'FileWriteResponse', 'RErrno');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mavros_msgs.FileWriteResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mavros_msgs.FileWriteResponse;
            obj.reload(strObj);
        end
    end
end
