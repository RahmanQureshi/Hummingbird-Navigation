classdef AprilTagDetection < robotics.ros.Message
    %AprilTagDetection MATLAB implementation of apriltag2_ros/AprilTagDetection
    ...
    properties (Constant)
        MessageType = 'apriltag2_ros/AprilTagDetection' % The ROS message type
    end
    ...
    methods
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseWithCovarianceStampedClass}, {'nonempty', 'scalar'}, 'AprilTagDetection', 'Pose');
        ...
        function set.Id(obj, id)
            ...
            validateattributes(id, {'numeric'}, {'vector'}, 'AprilTagDetection', 'Id');
        ...
        function set.Size(obj, size)
            ...
            validateattributes(size, {'numeric'}, {'vector'}, 'AprilTagDetection', 'Size');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.apriltag2_ros.AprilTagDetection.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.apriltag2_ros.AprilTagDetection;
            obj.reload(strObj);
        end
    end
end
