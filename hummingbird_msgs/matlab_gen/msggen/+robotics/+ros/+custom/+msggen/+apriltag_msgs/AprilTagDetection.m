classdef AprilTagDetection < robotics.ros.Message
    %AprilTagDetection MATLAB implementation of apriltag_msgs/AprilTagDetection
    ...
    properties (Constant)
        MessageType = 'apriltag_msgs/AprilTagDetection' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.apriltag_msgs.AprilTagDetection.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.apriltag_msgs.AprilTagDetection;
            obj.reload(strObj);
        end
    end
end
